...
export const metadata = { title: 'კონფიდენციალურობის პოლიტიკა — MagicStamp' }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              MagicStamp აგროვებს მინიმალურ მონაცემებს სერვისის გამართულად მუშაობისთვის:
            </p>
          ...
          <section>
            ...
            <p>
              ...
              MagicStamp Google Wallet-ს იყენებს მხოლოდ ბარათის ვიზუალური ჩვენებისთვის
