      ...
      <section className={s.section}>
        ...
        <div className={s.founder}>
          ...
          <div className={s.founderTxt}>
            <p>
              გამარჯობა, ჩვენ გიორგი და სანდრო ვართ. მუდმივი კლიენტი ახლის
              მოზიდვაზე ბევრად იაფია. ჩვენი მიზანია, Taply-ს საშუალებით ყველა
              ადგილობრივ ბიზნესს ჰქონდეს მათი შენარჩუნების მარტივი და
              ეფექტური გზა.
            </p>
            <a
