...
const STORY = [
  {
    ...
    text: 'იკარგება. ირეცხება. ნაგავში ხვდება. კლიენტიც — აღარ ბრუნდება.',
  },
  {
    title: 'Taply ტელეფონში ცხოვრობს',
    text: 'ერთი სკანი — და ბარათი უკვე Wallet-შია. აპის ჩამოტვირთვა არ სჭირდება.',
  },
  {
    title: 'კლიენტი ბრუნდება',
    text: 'კიდევ 2 ყავა — და საჩუქარი. დაბრუნების მიზეზი ყოველთვის თან აქვს.',
  },
]
      ...
      <div className={s.hero}>
        ...
        <div className={s.heroIn}>
          <div className={s.heroTxt}>
            ...
            <p className={s.sub}>
              ციფრული ბარათი, რომელიც ცხოვრობს ტელეფონში — Apple და Google
              Wallet-ში. აღარასდროს იკარგება.
            </p>
      ...
      <section className={s.section}>
        ...
        <div className={s.founder}>
          ...
          <div className={s.founderTxt}>
            <p>
              გამარჯობა, გიორგი ვარ. Taply-ს ვაშენებ თბილისის კაფეებისა და
              სალონებისთვის. კითხვა გაქვს? პირადად მომწერე.
            </p>
            <a
